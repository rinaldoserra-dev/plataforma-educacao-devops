...
{
    public class MatriculaAtivaDTOTest
    {
        ...
        [Fact(DisplayName = "MatriculaAtivaDTO.FromMatricula deve mapear corretamente a partir de Matricula ativa com certificado")]
        [Trait("Categoria", "Gestão Aluno - Application - DTO - MatriculaAtivaDTO")]
